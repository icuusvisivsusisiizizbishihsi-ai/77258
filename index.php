...
mkdir('data/txt');
mkdir('data/api');
$API_KEY= '8662523450:AAGhSuWQmXEbi0wUjYd72lyf1HhIGhCLGX4';
...
$chall = "jsjsshgw";
$useradmin = "Ahmed7725";
$sim =-1003741092315; #القناة الرسمية
$PAY =-1003777873008; #الارقام المكتملة
$ess =-1003742881763; #عمليات شراء الارقام
$eer =-1003754301554; #اشعارات الايميلات وتحويل الروبل
if($chat_id==8127101792){
$sudo=$chat_id;
}elseif($chat_id==8127101792){
$sudo=$chat_id;
}else{
$sudo==8127101792;
}
